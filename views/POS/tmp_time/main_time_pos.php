        ...
        <div class="col-md-9">
          <div class="box box-solid">
            <div class="box-body">
              <div class="row">
                <div class="col-md-4">
                  <input type='text' class='form-control' name='barcode' id='barcode' placeholder='<?php if ($serial == 0) echo "Ref. Number ที่ต้องการ"; else echo "Serial Number ที่ต้องการ"; ?>' autocomplete='off'>
                </div>
                <div class="col-md-1">
                ...
                <div class='col-md-12 table-responsive' style='overflow: auto;height: 400px;'>
                  <table class='table table-bordered' id='itemlist'>
                    <thead>
                      ...
                      <th class='col-xs-1'><?php if($serial==0) echo "Ref. Number"; else echo "Serial Number"; ?></th>
...
<script>
  var link_check = '<?php echo site_url('tmp_pos_time_sale/check_code'); ?>';
