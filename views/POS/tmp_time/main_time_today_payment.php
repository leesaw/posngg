                  ...
                  <table class='table table-bordered' id='paymentlist'>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo $loop->posp_small_invoice_number; if ($loop->posp_status == 'V') echo " <button class='btn btn-xs btn-danger'>ยกเลิก(Void)</button>"; ?></td>
